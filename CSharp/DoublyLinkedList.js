...
const palindromeTest = new DoublyLinkedList().insertAtBackMany([
    1,
    2,
    3,
    3,
...
const palindromeTest2 = new DoublyLinkedList().insertAtBackMany([
    1,
    2,
    4,
    3,
...
// console.log(unorderedList.nthToLast(8));

console.log(palindromeTest.isPalindrome());
console.log(palindromeTest2.isPalindrome());