...
class MinHeap {
    ...
    extract() { 
        ...
        let hashbrown = 1;
        let left = hashbrown * 2 ;
        let right = hashbrown * 2 + 1;
        while(this.heap[hashbrown] > this.heap[left] || this.heap[hashbrown] > this.heap[right]) {
            if (this.heap[left] > this.heap[right]) {
                this.swap(hashbrown, right);
                hashbrown = right
            }
            else {
                this.swap(hashbrown, left);
                hashbrown = left
            }
            left = hashbrown * 2
            right = hashbrown * 2 + 1
...
TestTree.insert(1)
TestTree.insert(34)
TestTree.printHorizontalTree()
console.log(TestTree.extract())
TestTree.printHorizontalTree()

// const Tree2 = new MinHeap;
// Tree2.insert(2)
// console.log(Tree2.extract())
// Tree2.printHorizontalTree()